...
const StyledSvg = styled.svg`
  fill: ${props => props.theme.textSpecial};
  width: 30px;
  height: 30px;
`
...
const ThemeToggle = () => {
  ...
  return (
    <>
      <Bounce bottom when={!themeContext.isDark} duration={1300} collapse>
        <StyledSvg
          className="sun"
          viewBox="0 0 24 24"
      ...
      <Bounce top when={themeContext.isDark} duration={1300} collapse>
        <StyledSvg
          className="moon"
          viewBox="0 0 24 24"
          onClick={() => themeContext.toggleDark()}
